                        ...
                        <div class="basic-form">
                            <form action="{{route('storePerusahaan')}}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="No Telepon" name="no_telp" id="no_telp" required="required">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Jumlah Pegawai" name="jumlah_pegawai" id="jumlah_pegawai" required="required">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">NPWP</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="NPWP" name="npwp" id="npwp" required="npwp">
                                    </div>
                                </div>
                                <div class="form-group row">
