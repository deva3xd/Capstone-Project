...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Tambah Data Pelamar</h1>
                </div>
                <div class="col-sm-6">
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('storeDataPelamar') }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Nama Pelamar</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('nama')is-invalid @enderror"
                                            placeholder="nama perusahaan" name="nama" id="nama" required="required">
                                        @error('nama')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control @error('ttl')is-invalid @enderror"
                                            placeholder="tanggal lahir pelamar" name="ttl" id="ttl"
                                            required="required">
                                        @error('ttl')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="pengalaman_kerja" required class="form-control @error('pengalaman_kerja')is-invalid  @enderror"
                                        id="pengalaman_kerja" style="width"></textarea>
