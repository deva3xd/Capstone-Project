      ...
      <div class="row">
        <div class="col-md-12">
          <div class="block text-center">
            <h1 class="text-capitalize mb-5 text-lg text-white">Detail Perusahaan</h1>
  </section>
      ...
      <div class="col-lg-12 mb-5">
          <div class="single-blog-item">
              ...
              <div class="blog-item-content mt-4">
                  <h2 class="mt-3 mb-3 text-md"><a href="blog-single.html">PT Suka Maju</a></h2>
                ...
                <p class="lead mb-4 text-primary">Informasi Perusahaan</p>
                  <div class="blog-item-meta mb-5">
                    <span class="text-muted text-capitalize mr-3"><i class="ti-comment mr-2"></i>Alamat</span>
                    <span class="text-muted text-capitalize mr-3"><i class="ti-comment mr-2"></i>No telpon</span>
                    <span class="text-muted text-capitalize mr-3"><i class="ti-comment mr-2"></i>Email</span>
                </div> 
