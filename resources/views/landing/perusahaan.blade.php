                ...
                <div class="col-md-12">
                    <div class="block text-center">
                        ...
                        <ul class="list-inline breadcumb-nav">
                            <li class="list-inline-item"><a href="{{ route('LandingPage') }}" class="text-white">Home</a>
                            </li>
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 mb-5">
                            <div class="blog-item">
                                ...
                                <div class="blog-item-content">
                                    <h3 class="mt-3 mb-3"><a href="blog-single.html">PT Suka Maju</a></h3>
                        ...
                        <div class="col-lg-12 col-md-12 mb-5">
                            <div class="blog-item">
                                <div class="blog-thumb">
                                    <img src="{{ asset('landing/images/blog/blog-2.jpg') }}" alt=""
                                        class="img-fluid rounded">
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 mb-5">
                            <div class="blog-item">
                                <div class="blog-thumb">
                                    <img src="{{ asset('landing/images/blog/blog-3.jpg') }}" alt=""
                                        class="img-fluid rounded">
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 mb-5">
                            <div class="blog-item">
                                <div class="blog-thumb">
                                    <img src="{{ asset('landing/images/blog/blog-4.jpg') }}" alt=""
                                        class="img-fluid rounded">
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 mb-5">
                            <div class="blog-item">
                                <div class="blog-thumb">
                                    <img src="{{ asset('landing/images/blog/blog-5.jpg') }}" alt=""
                                        class="img-fluid rounded">
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="sidebar-wrap pl-lg-4 mt-5 mt-lg-0">
                        ...
                        <div class="sidebar-widget latest-post mb-3">
                            <h5>Perusahaan Populer</h5>

                            <div class="media py-3">
                                <a href="#"><img class="mr-4" src="{{ asset('landing/images/blog/bt-3.jpg') }}"
                                        alt=""></a>
                                <div class="media-body">
                                    <span class="text-sm text-muted">12 Desember 2023</span>
                                    <h6 class="my-2"><a href="#">PT Suka Maju</a></h6>
                                </div>
                            </div>

                            <div class="media py-3">
                                <a href="#"><img class="mr-4" src="{{ asset('landing/images/blog/bt-2.jpg') }}"
                                        alt=""></a>
                                <div class="media-body">
                            ...
                            <div class="media py-3">
                                <a href="#"><img class="mr-4" src="{{ asset('landing/images/blog/bt-1.jpg') }}"
                                        alt=""></a>
                                <div class="media-body">
