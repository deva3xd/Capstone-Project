            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form enctype="multipart/form-data" action="{{ route('Profilupdate', ['pelamar' => $pelamar->id]) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-floating m-3">
                                ...
                                <textarea name="alamat" required class="form-control @error('alamat')is-invalid  @enderror" id="alamat" style="width">{{ $pelamar->alamat }}</textarea>
                                @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="no_telp" required id="no_telp" type="text"
                                    value="{{ $pelamar->no_telp }}" class="form-control @error('no_telp')is-invalid  @enderror">
                                    @error('no_telp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="pendidikan" required id="pendidikan" type="text"
                                    value="{{ $pelamar->pendidikan }}" class="form-control @error('pendidikan')is-invalid  @enderror">
                                    @error('pendidikan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="nama_institusi" required id="nama_institusi" type="text"
                                    value="{{ $pelamar->nama_institusi }}" class="form-control @error('nama_institusi')is-invalid  @enderror"">
                            ...
                            <div class="form-floating m-3">
                                ...
                                <textarea name="pengalaman_organisasi" required class="form-control @error('pengalaman_organisasi')is-invalid  @enderror" id="pengalaman_organisasi" style="width">{{ $pelamar->pengalaman_organisasi }}</textarea>
                            ...
                            <div class="form-floating m-3">
                                ...
                                <textarea name="pengalaman_kerja" required class="form-control @error('pengalaman_kerja')is-invalid  @enderror" id="pengalaman_kerja" style="width">{{ $pelamar->pengalaman_kerja }}</textarea>
                            ...
                            <div class="form-floating m-3">
                                ...
                                <textarea name="skill" class="form-control @error('skill')is-invalid  @enderror" id="skill" style="width" required>{{ $pelamar->skill }}</textarea>
                                @error('skill')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="gaji_diinginkan" id="gaji_diinginkan" type="text"
                                    value="{{ $pelamar->gaji_diinginkan }}"class="form-control @error('gaji_diinginkan')is-invalid  @enderror" required>
