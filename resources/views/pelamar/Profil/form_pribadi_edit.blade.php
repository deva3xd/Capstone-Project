                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('Profilupdate', ['profil' => $profil->id]) }}" method="POST">
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="nama" id="nama" required type="text" value="{{ $profil->nama }}"
                            ...
                            <div class="form-floating m-3">
                                ...
                                <textarea name="alamat" required class="form-control @error('alamat')is-invalid  @enderror" id="alamat" style="width">{{ $profil->alamat }}</textarea>
                                @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="ttl" id="ttl" required type="date" value="{{ $profil->ttl }}"
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="pendidikan" required id="pendidikan" type="text"
                                    value="{{ $profil->pendidikan }}" class="form-control @error('pendidikan')is-invalid  @enderror">
                                    @error('pendidikan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="nama_institusi" required id="nama_institusi" type="text"
                                    value="{{ $profil->nama_institusi }}" class="form-control @error('nama_institusi')is-invalid  @enderror"">
                            ...
                            <div class="form-floating m-3">
                                ...
                                <textarea name="pengalaman_organisasi" required class="form-control @error('pengalaman_organisasi')is-invalid  @enderror" id="pengalaman_organisasi" style="width">{{ $profil->pengalaman_organisasi }}</textarea>
                            ...
                            <div class="form-floating m-3">
                                ...
                                <textarea name="pengalaman_kerja" required class="form-control @error('pengalaman_kerja')is-invalid  @enderror" id="pengalaman_kerja" style="width">{{ $profil->pengalaman_kerja }}</textarea>
                            ...
                            <div class="form-floating m-3">
                                ...
                                <textarea name="skill" class="form-control @error('skill')is-invalid  @enderror" id="skill" style="width" required>{{ $profil->skill }}</textarea>
                                @error('skill')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="sertifikasi" id="sertifikasi" value="{{ $profil->sertifikasi }}"
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="gaji_diinginkan" id="gaji_diinginkan" type="text"
                                    value="{{ $profil->gaji_diinginkan }}"class="form-control @error('gaji_diinginkan')is-invalid  @enderror" required>
                            ...
                            <div class="form-group m-3">
                                ...
                                <input name="nik" id="nik" type="number" value="{{ $profil->nik }}"
