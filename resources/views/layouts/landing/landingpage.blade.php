			   ...
			   <li class="nav-item"><a class="nav-link" href="{{ route('LowonganLandingPage') }}">Lowongan</a></li>
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu border rounded" aria-labelledby="navbarDropdown">
					  <a class="dropdown-item" href="{{ route('login') }}" name="role" value="perusahaan"><i class="fas fa-building m-1"></i>Perusahaan</a>
					  <a class="dropdown-item" href="{{ route('login') }}" name="role" value="pelamar"><i class="fas fa-user m-1"></i>Pelamar</a>
					</div>
				  </li>			  
			</ul>			
		  </div>
