...
Route::middleware(['auth', 'PerusahaanMiddleware'])->group(function () {
    ...
    Route::post('/perusahaan/profile/buat/update/{perusahaan}', 'DashboardController@updateProfilePerusahaan')->name('UpdateProfilePerusahaan');
    Route::get('/perusahaan/profile/buat', 'DashboardController@profileBuatPerusahaan')->name('BuatProfilePerusahaan');
    Route::post('/perusahaan/profile/buat/store', 'DashboardController@storeProfilePerusahaan')->name('StoreProfilePerusahaan');
